        ...
        do {
            ...
            try {
                ...
                if (option == 1){
                    ...
                    System.out.println("O Produto está em Promoção? [S/N]"); //CASO ESTEJA EM PROMOÇÃO, DESCONTO APLICADO DE 15%.
                    aux = scanVenda.next();
                ...
                System.out.println("TENTE DIGITAR NÚMEROS, AO INVÉS DE LETRAS");
                scan.next();
            }catch (NullPointerException e){
                System.out.println("Possível Erro na Leitura de Dados da Venda do Produto, Repita [REGISTRAR UMA VENDA] de Forma Correta!!");
            }catch (Exception e){
